...
class ConfigWriter:
    ...
    def write_backend_env(self, config: SetupConfig) -> Tuple[bool, str]:
        ...
        env_vars = {
            ...
            # CarbonScope
            "CarbonScope_ADMIN_API_KEY": config.CarbonScope.CarbonScope_ADMIN_API_KEY,
            # VAPI
        ...
        header = f"Generated by CarbonScope carbonscope setup for '{setup_method}' setup"
    ...
    def write_frontend_env(self, config: SetupConfig) -> Tuple[bool, str]:
        ...
        header = "Generated by CarbonScope carbonscope setup"
        content = self._format_env_content(env_vars, header)
