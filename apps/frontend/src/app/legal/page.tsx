                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <div className="text-muted-foreground mb-6 space-y-2">
                        <p>
                          <strong>CarbonScope AI Corp</strong>
                        </p>
                      ...
                      <div className="text-muted-foreground mb-6">
                        <p>
                          Email:{' '}
                          <a
                            href="mailto:info@CarbonScope.com"
                            className="text-primary hover:underline"
                          >
                            info@CarbonScope.com
                          </a>
                        </p>
                      </div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        CarbonScope AI Corp is responsible for the content of this
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        CAREFULLY BEFORE USING THE SERVICES OFFERED BY CarbonScope AI
                        ...
                        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE CarbonScope
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        <li>
                          "Company" refers to CarbonScope AI Corp, a Delaware corporation
                          with its principal place of business at 701 Tillery Street
                          Unit 12-2521, Austin, Texas 78702, United States.
                        </li>
                        <li>
                          "Site" refers to the CarbonScope website, including any related
                          features, content, or applications offered from time to
                          time by the Company.
                        </li>
                        <li>
                          "Service" refers to the CarbonScope platform and all related
                        ...
                        <li>
                          ...
                          Company, specifically legal@CarbonScope.com
                        </li>
                        <li>
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        CarbonScope is a complete platform for creating, managing, and
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        please write to legal@CarbonScope.com and we will process and
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        or by emailing us at info@CarbonScope.com. If you cancel
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        GitHub repository. Self-hosting is governed by the CarbonScope Public
                        ...
                        and contact{' '}
                        <a
                          href="mailto:hey@CarbonScope.com"
                          className="text-primary hover:underline"
                        >
                          hey@CarbonScope.com
                        </a>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All CarbonScope logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE CarbonScope WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        CarbonScope DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        <a
                          href="mailto:legal@CarbonScope.com"
                          className="text-primary hover:underline"
                        >
                          legal@CarbonScope.com
                        </a>
                        .
                      </p>
                      <p className="text-muted-foreground text-balance mb-4">
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        <strong>Mailing Address:</strong> CarbonScope AI Corp, 701 Tillery
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at CarbonScope in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        CarbonScope does not collect biometric or identifying
