  ...
  try {
    ...
    if (!packageIdentifier) {
      const creditPackageMap: Record<number, string> = {
        10: 'CarbonScope_topup_starter',
        25: 'CarbonScope_topup_plus',
        50: 'CarbonScope_topup_popular',
        100: 'CarbonScope_topup_pro',
        250: 'CarbonScope_topup_business',
        500: 'CarbonScope_topup_enterprise',
      };
