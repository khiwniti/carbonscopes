...
from .tools import AgentPressTools, MCPTools, CarbonScopeTools
...
class Agent:
    ...
    async def update(
        ...
        mcp_tools: list[CarbonScopeTools] | None = None,
...
class CarbonScopeAgent:
    ...
    async def create(
        ...
        name: str,
        system_prompt: str,
        mcp_tools: list[CarbonScopeTools] = [],
        allowed_tools: list[str] | None = None,
    ) -> Agent:
        agentpress_tools = {}
