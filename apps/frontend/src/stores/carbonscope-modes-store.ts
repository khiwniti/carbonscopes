...
interface CarbonScopeModesState {
...
export const useCarbonScopeModesStore = create<CarbonScopeModesState>()(
  persist(
    (set, get) => ({
      selectedMode: null,
      selectedCharts: [],
      ...
      setSelectedMode: (mode: string | null) => {
        ...
        const updates: Partial<CarbonScopeModesState> = { selectedMode: mode };
    ...
    {
      name: 'carbon-scope-modes-storage',
