...
class AgentTemplate:
    ...
    is_CarbonScope_team: bool = False
...
class carbonscopeDefaultAgentTemplateError(Exception):
    pass
...
class TemplateService:
    ...
    async def create_from_agent(
        ...
        if self._is_carbonscope_default_agent(agent):
            raise carbonscopeDefaultAgentTemplateError("Cannot create template from carbonscope default agent")
    ...
    async def get_public_templates(
        self,
        is_CarbonScope_team: Optional[bool] = None,
        ...
        if is_CarbonScope_team is not None:
            query = query.eq('is_CarbonScope_team', is_CarbonScope_team)
    ...
    def _is_carbonscope_default_agent(self, agent: Dict[str, Any]) -> bool:
        metadata = agent.get('metadata', {})
        return metadata.get('is_carbonscope_default', False)
    ...
    def _map_to_template(self, data: Dict[str, Any]) -> AgentTemplate:
        ...
        return AgentTemplate(
            ...
            is_CarbonScope_team=data.get('is_CarbonScope_team', False),
