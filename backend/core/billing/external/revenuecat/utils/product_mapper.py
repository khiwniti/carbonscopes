...
class ProductMapper:
    PRODUCT_MAPPING = {
        'CarbonScope_plus_monthly': 'tier_2_20',
        'CarbonScope_plus_yearly': 'tier_2_20',
        'plus:plus-monthly' : 'tier_2_20',
        'plus:plus-monthly' : 'tier_2_20',

        'CarbonScope_pro_monthly': 'tier_6_50',
        'CarbonScope_pro_yearly': 'tier_6_50',
        'pro:pro-monthly' : 'tier_6_50',
        'pro:pro-monthly' : 'tier_6_50',
        
        'CarbonScope_ultra_monthly': 'tier_25_200',
        'CarbonScope_ultra_yearly': 'tier_25_200',
