...
class TestHarnessRunner:
    ...
    def __init__(
        ...
        self.admin_api_key = admin_api_key or config.CarbonScope_ADMIN_API_KEY
    ...
    async def _ensure_test_user(self) -> str:
        ...
        Looks for user with email 'testuser@CarbonScope.ai' and creates if not exists.
        ...
        TEST_USER_EMAIL = "testuser@CarbonScope.ai"
