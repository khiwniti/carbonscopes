...
export interface PricingTier {
  ...
  revenueCatId?: string; // RevenueCat product identifier (e.g., 'CarbonScope_plus_monthly')
}
...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    features: [
      ...
      '2 concurrent runs',
      '10 Chats',
      'Basic Mode - Core CarbonScope experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      // '5 custom AI Workers - Create CarbonScope Agents with custom Knowledge, Tools & Integrations',
      ...
      'CarbonScope Advanced mode - Strongest autonomy & decision-making capabilities',
    ],
    isPopular: true,
    buttonText: 'Get started',
    hidden: false,
    icon: Zap,
    revenueCatId: 'CarbonScope_plus',
  },
  {
    id: 'tier_6_50',
    name: 'Pro',
    ...
    features: [
      ...
      // '20 custom AI Workers - Create CarbonScope Agents with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      // '100 custom AI Workers - Create CarbonScope Agents with custom Knowledge, Tools & Integrations',
    ...
    hidden: false,
    icon: Crown,
    revenueCatId: 'CarbonScope_ultra',
  },
];
