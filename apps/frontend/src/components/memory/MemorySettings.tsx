        ...
        <Alert className="border-primary/20 bg-primary/5">
          ...
          <AlertDescription className="text-sm">
            ...
            <p className="text-muted-foreground mt-1">
              Memory is currently under development. This feature will allow CarbonScope to remember important information from your conversations to provide more personalized and context-aware responses.
            </p>
          </AlertDescription>
        </Alert>
      </div>
