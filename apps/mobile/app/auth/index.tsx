...
import CarbonScopeSymbolBlack from '@/assets/brand/CarbonScope-symbol-scale-effect-black.svg';
import CarbonScopeSymbolWhite from '@/assets/brand/CarbonScope-symbol-scale-effect-white.svg';
...
function AuthBackgroundLogo() {
  ...
  const SymbolComponent = colorScheme === 'dark' ? CarbonScopeSymbolWhite : CarbonScopeSymbolBlack;
  ...
  return (
    ...
    >
        ...
        <View style={{ marginBottom: SPACING.logoToTitle }}>
          <CarbonScopeLogo variant="logomark" size={24} color={isDark ? 'dark' : 'light'} />
        </View>
