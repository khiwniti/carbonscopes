...
export const clearUserLocalStorage = () => {
  ...
  try {
    ...
    // localStorage.removeItem('carbonscope-preferred-model-v3');
    localStorage.removeItem('customModels');
    localStorage.removeItem('carbonscope-model-selection-v2');
    ...
    localStorage.removeItem('carbonscope_upgrade_dialog_displayed');
