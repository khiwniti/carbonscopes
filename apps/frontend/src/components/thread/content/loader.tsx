...
// Add global styles for loader animation
if (typeof document !== 'undefined') {
  const styleId = 'agent-loader-styles';
...
.thinking-text { font-size: 14px; background: linear-gradient(90deg, currentColor 0%, currentColor 25%, rgba(255, 255, 255, 0.55) 50%, currentColor 75%, currentColor 100%); background-size: 200% 100%; -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent; animation: shimmerFlow 1.8s linear infinite; transition: opacity 0.2s ease, transform 0.2s ease; }
...
export const AgentLoader = () => {
  ...
  return (
    <div className="flex py-2 items-center gap-2.5 w-full">
      ...
      {/* Fun cycling text */}
      <span className={`text-sm text-muted-foreground whitespace-nowrap thinking-text ${
