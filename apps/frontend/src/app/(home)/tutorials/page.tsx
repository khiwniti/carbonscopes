...
const tutorials: Tutorial[] = [
  {
    id: 'introduction-to-CarbonScope',
    title: 'Introduction to CarbonScope',
    description: 'Get a comprehensive overview of CarbonScope and discover the different AI-powered content generation modes available to supercharge your workflow.',
    duration: '3 min',
    icon: Sparkles,
  ...
  },
  {
    ...
    description: 'Learn the basics of creating and completing your first task with CarbonScope. This tutorial walks you through the essential workflow to get you productive right away.',
    duration: '4 min',
    icon: Rocket,
    embedCode: `<div style="position: relative; padding-bottom: calc(57.3684% + 41px); height: 0px; width: 100%;"><iframe src="https://demo.arcade.software/8tC4UfBbqMpsUo6CM30i?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="Your first task with CarbonScope" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; color-scheme: light;" ></iframe></div>`,
  },
  {
    id: 'create-export-presentations',
    title: 'How to Create and Export Presentations',
    description: 'Discover how to create stunning presentations with CarbonScope and export them in various formats for sharing and presenting.',
    duration: '4 min',
    icon: Presentation,
  ...
  },
  {
    ...
    title: 'How to Create and Manage Files with CarbonScope',
    description: 'Learn how to create, organize, and manage files with CarbonScope. This tutorial covers downloading data, exporting to different formats like Excel, and more.',
    duration: '3 min',
    icon: FolderOpen,
  ...
  },
  {
    ...
    description: 'Explore the powerful media creation capabilities of CarbonScope. Learn how to generate videos and images using AI to enhance your projects.',
    duration: '3 min',
    icon: Video,
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 pt-28 md:pt-32 pb-12">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Step-by-step interactive tutorials to help you get the most out of CarbonScope. 
          ...
          <div className="flex-1 min-w-0 space-y-16">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground max-w-md mx-auto">
                We&apos;re always adding new tutorials to help you get the most out of CarbonScope. 
