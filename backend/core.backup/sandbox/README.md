...
2. Build a custom image:
   ...
   docker push CarbonScope/suna:0.1.3.30
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `CarbonScope/suna:___`)
...
3. Push the new version: `docker push CarbonScope/suna:0.1.3`
