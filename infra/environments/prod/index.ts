...
const apiWorkload = new ApiWorkload("carbonscope-api", {
  ...
  ingress: {
    enabled: true,
    host: config.get("primaryDomain") || "api-eks.CarbonScope.com",
    annotations: {
...
export const outputs = {
  ...
  endpoints: {
    primary: config.get("primaryDomain") || "api-eks.CarbonScope.com",
    lightsail: config.get("lightsailDomain") || "api-lightsail.CarbonScope.com",
  },
};
