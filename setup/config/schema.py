...
class MainLLMProvider(str, Enum):
    """Main LLM provider for CarbonScope/basic model."""
...
class CarbonScopeConfig(BaseModel):
    """CarbonScope admin configuration."""

    CarbonScope_ADMIN_API_KEY: str = ""
...
class SetupConfig(BaseModel):
    ...
    CarbonScope: CarbonScopeConfig = Field(default_factory=CarbonScopeConfig)
