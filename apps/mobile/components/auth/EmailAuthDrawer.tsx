                ...
                <View className="flex-row items-start">
                  ...
                  <View className="flex-1 flex-row flex-wrap">
                    ...
                    <BottomSheetTouchable onPress={async () => {
                      ...
                      await WebBrowser.openBrowserAsync('https://www.CarbonScope.com/legal?tab=terms', {
                    ...
                    <BottomSheetTouchable onPress={async () => {
                      await Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                      const WebBrowser = await import('expo-web-browser');
                      await WebBrowser.openBrowserAsync('https://www.CarbonScope.com/legal?tab=privacy', {
                        presentationStyle: WebBrowser.WebBrowserPresentationStyle.PAGE_SHEET,
                        controlsColor: isDark ? '#FFFFFF' : '#000000',
                      });
                    }}>
