...
CarbonScope_HELLO_EMAIL = 'hello@CarbonScope.com'
...
class NotificationService:
    ...
    async def send_task_completion_notification(
        ...
        try:
            ...
            task_url = f"https://www.CarbonScope.com/projects/{project_id}/thread/{thread_id}" if project_id else f"https://www.CarbonScope.com/thread/{thread_id}"
