...
const PROTOCOL_SCHEME = 'CarbonScope';

// Get URL from environment variable or default to production
const APP_URL = process.env.APP_URL || 'https://CarbonScope.com/';
...
if (process.platform === 'darwin') {
  app.setName('CarbonScope');
}

// Register as default protocol handler for CarbonScope://
...
function handleDeepLink(url) {
  ...
  // Convert CarbonScope://auth/callback?code=xxx to https://CarbonScope.com/auth/callback?code=xxx
...
function createWindow() {
  ...
  webContents.setUserAgent(webContents.getUserAgent() + ' Electron/CarbonScope-Desktop');
