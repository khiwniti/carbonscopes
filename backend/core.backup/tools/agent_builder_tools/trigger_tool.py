...
class TriggerTool(AgentBuilderBaseTool):
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "include_CarbonScope": {
                        "type": "boolean",
                        "description": "Whether to include the built-in CarbonScope worker in results. Defaults to false."
                    }
                },
                "required": []
            }
    ...
    async def list_account_workers(
        ...
        include_CarbonScope: bool = False,
    ) -> ToolResult:
        try:
            workers = await self._get_account_workers()
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {
                        "type": "string",
                        "description": "Model to use for the scheduled execution. Options: 'CarbonScope/basic' (default, free tier) or 'CarbonScope/power' (requires paid subscription). If not specified, defaults to 'CarbonScope/basic'."
                    }
                },
    ...
    async def create_scheduled_trigger(
        ...
        try:
            ...
            trigger_config: Dict[str, Any] = {
                ...
                "model": model or "CarbonScope/basic"
            }
        ...
        try:
            ...
            for trigger in schedule_triggers:
                formatted = {
                    ...
                    "model": trigger.config.get("model", "CarbonScope/basic"),
                    "is_active": trigger.is_active
                }
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {"type": "string", "description": "Model to use for the event execution. Options: 'CarbonScope/basic' (default, free tier) or 'CarbonScope/power' (requires paid subscription). If not specified, defaults to 'CarbonScope/basic'."}
                },
