/**
 * BILLING DISABLED - Pricing page shows free access message
 */
...
export const metadata: Metadata = {
  title: 'Pricing',
  description: 'Free unlimited access - billing is disabled',
};
    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--carbonscope-background)]">
      <div className="text-center max-w-md mx-auto p-8">
        ...
        <p className="text-[var(--carbonscope-text-secondary)] mb-8">
          CarbonScope is currently available with unlimited free access. No payment required.
        </p>
        <Link 
          href="/dashboard"
