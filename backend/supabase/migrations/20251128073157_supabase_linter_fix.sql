...
DECLARE
    func_names TEXT[] := ARRAY[
        ...
        'count_carbonscope_agents_by_version',
        'find_carbonscope_default_agent_for_account',
        'get_all_carbonscope_default_agents',
        'get_carbonscope_default_agent_stats',
        'find_carbonscope_agents_needing_update',
