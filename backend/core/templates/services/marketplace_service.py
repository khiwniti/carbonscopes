...
class MarketplaceFilters:
    def __init__(
        ...
        self.search = search
        self.tags = tags or []
        self.is_CarbonScope_team = is_CarbonScope_team
...
class MarketplaceService:
    ...
    async def get_marketplace_templates_paginated(
        ...
        try:
            ...
            templates = await template_service.get_public_templates(
                is_CarbonScope_team=filters.is_CarbonScope_team,
                limit=limit,
                offset=offset,
    ...
    def _build_marketplace_base_query(self, filters: MarketplaceFilters):
        ...
        if filters.is_CarbonScope_team is not None:
            query = query.eq('is_CarbonScope_team', filters.is_CarbonScope_team)
