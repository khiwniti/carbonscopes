...
class ComposioStep(BaseStep):
    ...
    def run(self) -> StepResult:
        ...
        if has_existing:
            ...
            self.info("Composio is REQUIRED for CarbonScope Suna. Without this key, Composio features will fail.")
            self.info("Composio provides tools and integrations for CarbonScope Suna agents.")
