...
class EmailService:
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to CarbonScope — Let's Get Started "
    ...
    def send_referral_email(
        ...
        try:
            ...
            mail = mt.Mail(
                sender=mt.Address(email=sender_email_to_use, name='CarbonScope'),
...
<head>
  ...
  <title>Welcome to CarbonScope</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://heprlhlltebrxydgtsjs.supabase.co/storage/v1/object/public/image-uploads/loaded_images/Profile%20Picture%20Black.png" alt="CarbonScope Logo" class="logo">
    </div>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to <a href="https://www.CarbonScope.com/">CarbonScope.com</a> — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the CarbonScope community!</p>
  </div>
</body>
</html>"""
...
Welcome to https://www.CarbonScope.com/ — we're excited to have you on board!
...
Thanks again, and welcome to the CarbonScope community!

---
© 2025 CarbonScope. All rights reserved.
You received this email because you signed up for a CarbonScope account."""
  ...
  <tr>
    <td>
      ...
      <p style="margin:0 0 20px 0; font-size:15px; line-height:1.6;">
        <strong>{sender_name}</strong> has invited you to join CarbonScope using a personal referral code.
    ...
    <tr>
      <td>
        <div style="text-align: center; margin-bottom: 40px;">
          <img src="https://CarbonScope.com/Logomark.svg" alt="CarbonScope" style="height: 24px; width: auto; display: inline-block;" />
        </div>
        ...
        <div style="text-align: center; margin-top: 32px;">
          <p style="font-size: 12px; color: #999; margin: 0;">
            &copy; CarbonScope AI Corp. All rights reserved.
          </p>
        </div>
      </td>
    </tr>
...
{sender_name} has invited you to join CarbonScope using a personal referral code.
...
---
© CarbonScope AI Corp. All rights reserved."""
    ...
    def send_otp_email(self, user_email: str, otp_code: str) -> bool:
        ...
        subject = "Your CarbonScope verification code"
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #fafafa; color: #1a1a1a;">
  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 520px; margin: 0 auto; padding: 40px 20px;">
    ...
    def _get_otp_email_text(self, otp_code: str) -> str:
        return f"""Your CarbonScope verification code
