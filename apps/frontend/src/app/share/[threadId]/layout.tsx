...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | CarbonScope',
    description: 'Replay this Worker conversation on CarbonScope',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | CarbonScope';
    const description =
      projectData.description ||
      'Replay this Worker conversation on CarbonScope';
