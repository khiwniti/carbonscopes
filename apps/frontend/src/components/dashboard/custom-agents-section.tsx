...
import { useCarbonScopeTeamTemplates, useInstallTemplate } from '@/hooks/secure-mcp/use-secure-mcp';
...
export function CustomAgentsSection({ onAgentSelect }: CustomAgentsSectionProps) {
  ...
  const { data: templates, isLoading, error } = useCarbonScopeTeamTemplates();
