    ...
    <>
      ...
      <View className="flex-1 bg-background">
        ...
        <View className="pt-14 px-6 pb-2 flex-row justify-between items-center">
          <CarbonScopeLogo variant="logomark" size={14} color={isDark ? 'dark' : 'light'} />
          <TouchableOpacity
        ...
        <View className="flex-1 p-4">
          ...
          <View className="flex-1">
            <View className="flex-row items-center gap-1.5 mb-2">
              <CarbonScopeLogo variant="symbol" size={14} color={isDark ? 'dark' : 'light'} />
            ...
            <View className="px-4 py-2 flex-row items-center justify-between">
              <View className="flex-row items-center gap-2">
                ...
                <Text className="text-[14px] font-roobert-medium text-foreground">
                  {t('onboarding.CarbonScopeComputer')}
                </Text>
              </View>
...
function SpinningLoader() {
  return <CarbonScopeLoader size="small" customSize={16} />;
}
