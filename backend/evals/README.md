# BKS cBIM AI Agent Evaluations

Evaluate BKS cBIM AI agent performance using **Braintrust** with JSON-based test cases.
...
Results are automatically uploaded to: https://www.braintrust.dev/app/BKS cBIM AI/p/BKS cBIM AI%20Agent/experiments/
...
runner = AgentEvalRunner(
    project_name="BKS cBIM AI Agent",
...
| `EVAL_MODEL` | Override model for evals (default: `cbim/basic`) |
