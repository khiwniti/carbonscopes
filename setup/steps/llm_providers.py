...
class LLMProvidersStep(BaseStep):
    ...
    # Main LLM provider options for CarbonScope/basic and CarbonScope/power models
    ...
    def _configure_main_provider(self) -> None:
        """Configure the main LLM model (required for CarbonScope/basic)."""
        self.console.print("\n" + "=" * 60)
    ...
    def _collect_required_key(self, env_key: str, provider_name: str) -> None:
        ...
        while True:
            ...
            if api_key:
                ...
                self.error(f"{provider_name} API key is REQUIRED for CarbonScope to function.")
