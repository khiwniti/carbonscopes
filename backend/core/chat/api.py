"""Chat API - natural language prompts that trigger agent / computer-use flows."""
...
async def chat_endpoint(
    ...
    Creates a thread (or reuses an existing one) then kicks off
    ...
    try:
        ...
        # 2. Resolve model (get DB client only when needed for model resolution)
        db = DBConnection()
