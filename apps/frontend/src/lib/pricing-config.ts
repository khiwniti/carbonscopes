...
export const pricingTiers: PricingTier[] = [
  {
    ...
    description: 'Perfect for trying out CarbonScope AI Workers',
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create CarbonScope Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create CarbonScope Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create CarbonScope Workers with custom Knowledge, Tools & Integrations',
