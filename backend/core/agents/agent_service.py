...
class AgentService:
    ...
    async def _passes_complex_filters(
        ...
        elif agent.is_carbonscope_default:
            await self.loader._load_carbonscope_config(agent, agent.account_id)
        else:
    ...
    async def _transform_template_to_agent_format(self, template_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result.update({
            ...
            "is_CarbonScope_team": template_data.get('is_CarbonScope_team', False)
        })
