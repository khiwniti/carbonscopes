    ...
    def run(self) -> StepResult:
        ...
        if not self._check_project_structure():
            return StepResult.fail(
                ...
                ["Make sure you're in the CarbonScope Suna repository root"],
            )

        self.success("CarbonScope Suna repository detected.")
    ...
    def _check_project_structure(self) -> bool:
        ...
        for directory in required_dirs:
            ...
            if not os.path.isdir(path):
                self.error(
                    f"'{directory}' directory not found. Make sure you're in the CarbonScope Suna repository root."
                )
                return False
        ...
        for file in required_files:
            ...
            if not os.path.isfile(path):
                self.error(
                    f"'{file}' not found. Make sure you're in the CarbonScope Suna repository root."
                )
                return False
