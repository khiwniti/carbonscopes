...
'Triggers a webhook to the backend when a new user is created. The webhook handles account initialization (free tier + carbonscope agent) and welcome email. Endpoint: /v1/webhooks/user-created';
