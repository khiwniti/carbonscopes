      ...
      >
        ...
        <View className="flex-row items-center justify-between mb-6">
          <View className="flex-1">
            ...
            <Text className="text-sm font-roobert text-muted-foreground">
              {t('chat.feedbackHelpsImprove', { defaultValue: 'Your feedback helps improve CarbonScope' })}
            </Text>
          </View>
          <BottomSheetTouchable
            onPress={handleClose}
        ...
        >
          ...
          <Text className="text-sm font-roobert text-foreground flex-1">
            {t('chat.helpCarbonScopeImprove', { defaultValue: 'Help CarbonScope improve with this feedback' })}
          </Text>
        </BottomSheetTouchable>
