    ...
    async def execute_step(self) -> AsyncGenerator[Dict[str, Any], None]:
        ...
        if has_archive:
            archive_preamble = (
                ...
                "files at /workspace/.CarbonScope/context/ BEFORE answering. Do NOT guess or use general knowledge.\n\n"
            )
            archive_hint = (
                ...
                "**For specific data:** grep -ri \"keyword\" /workspace/.CarbonScope/context/messages/\n"
