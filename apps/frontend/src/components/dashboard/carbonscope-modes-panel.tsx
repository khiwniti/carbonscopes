...
interface CarbonScopeModesPanelProps {
...
export function CarbonScopeModesPanel({ 
  selectedMode, 
  onModeSelect, 
  onSelectPrompt, 
  isMobile = false,
  ...
  const selectTemplate = useCarbonScopeModesStore((state) => state.selectTemplate);
  const selectOutputFormat = useCarbonScopeModesStore((state) => state.selectOutputFormat);
  const selectCharts = useCarbonScopeModesStore((state) => state.selectCharts);
  const selectDocsType = useCarbonScopeModesStore((state) => state.selectDocsType);
  const selectImageStyle = useCarbonScopeModesStore((state) => state.selectImageStyle);
  const selectCanvasAction = useCarbonScopeModesStore((state) => state.selectCanvasAction);
  const selectVideoStyle = useCarbonScopeModesStore((state) => state.selectVideoStyle);
  const storeSetSelectedMode = useCarbonScopeModesStore((state) => state.setSelectedMode);
  ...
  return (
    <div className="w-full space-y-4" data-testid="carbonscope-modes">
