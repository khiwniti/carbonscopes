# CarbonScope Agent Evaluations

Evaluate CarbonScope agent performance using **Braintrust** with JSON-based test cases.
...
Results are automatically uploaded to: https://www.braintrust.dev/app/CarbonScope/p/CarbonScope%20Agent/experiments/
...
runner = AgentEvalRunner(
    project_name="CarbonScope Agent",
...
| `EVAL_MODEL` | Override model for evals (default: `CarbonScope/basic`) |
