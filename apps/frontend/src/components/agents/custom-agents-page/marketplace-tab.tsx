...
interface MarketplaceTabProps {
  ...
  marketplaceFilter: 'all' | 'CarbonScope' | 'community' | 'mine';
  setMarketplaceFilter: (value: 'all' | 'CarbonScope' | 'community' | 'mine') => void;
    ...
    <div className="space-y-6 mt-8 flex flex-col min-h-full">
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <Select value={marketplaceFilter} onValueChange={(value: 'all' | 'CarbonScope' | 'community' | 'mine') => setMarketplaceFilter(value)}>
            ...
            <SelectContent className='rounded-xl'>
              ...
              <SelectItem className='rounded-xl' value="CarbonScope">CarbonScope Verified</SelectItem>
                  ...
                  {allMarketplaceItems.map((item) => (
                    <UnifiedAgentCard
                      ...
                      data={{
                        ...
                        is_CarbonScope_team: item.is_CarbonScope_team,
