        ...
        <div className="space-y-8 py-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Credits are the universal currency that powers everything you do on CarbonScope. 
              ...
              <CardContent className="pt-5">
                <ul className="space-y-2.5 text-sm text-muted-foreground">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-primary mt-1.5 flex-shrink-0" />
                    <div>
                      <span className="font-medium text-foreground">CarbonScope computer:</span> Code execution, browser automation, and interactive task processing.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-primary mt-1.5 flex-shrink-0" />
