...
class InstallationService:
    ...
    async def _create_agent(
        ...
        if template.is_CarbonScope_team:
            metadata['is_CarbonScope_team'] = True
            metadata['CarbonScope_template_id'] = template.template_id
        ...
        logger.debug(f"Created agent {agent_id} from template {template.template_id}, is_CarbonScope_team: {template.is_CarbonScope_team}")
        return agent_id
