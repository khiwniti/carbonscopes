      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="text-lg mb-8">
            Credits are CarbonScope's standard unit of measurement for platform usage. Think of them as tokens that power your AI agents - the more complex or lengthy the task, the more credits it requires.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-6">
            CarbonScope uses two types of credits to give you flexibility in how you manage your usage:
          </p>
          ...
          <Alert className="mb-8">
            ...
            <AlertDescription>
              <strong>Credit Priority:</strong> When you use CarbonScope, expiring credits are consumed first. 
        ...
        <section>
          ...
          <p className="mb-6">
            There are several ways to obtain credits in CarbonScope:
          </p>
        ...
        <section>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-8">
            <Button
              variant="outline"
              className="gap-2"
              onClick={() => window.location.href = 'mailto:hey@CarbonScope.com'}
            >
