 ...
 * 
 * Note: The backend should return CarbonScope.com URLs that wrap/proxy Stripe,
...
// checkout URLs (should be CarbonScope.com masked URLs, not direct stripe.com)
// ============================================================================
 ...
 * a CarbonScope.com masked URL (not direct stripe.com for compliance)
 */
...
export async function openBillingPortal(returnUrl?: string): Promise<void> {
  ...
  try {
    ...
    const webBillingUrl = process.env.EXPO_PUBLIC_WEB_APP_URL 
      ...
      : 'https://www.CarbonScope.com/subscription';
