              ...
              <div className="flex flex-col items-center justify-center gap-6 pt-12 max-w-4xl mx-auto pb-16">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                  <Button asChild size="lg" className="text-base h-14 w-48 rounded-full px-8">
                    <a href="mailto:support@CarbonScope.com">
                ...
                <p className="text-sm text-muted-foreground">
                  Or email us directly at <a href="mailto:support@CarbonScope.com" className="text-primary hover:underline font-medium">support@CarbonScope.com</a>
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 border-t border-border">
                <div className="p-8 border-r border-border space-y-4">
                  ...
                  <div>
                    ...
                    <a 
                      href="mailto:support@CarbonScope.com" 
                ...
                <div className="p-8 space-y-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@CarbonScope.com" className="text-primary hover:underline font-medium">
                      Contact us
                    </a>
                  </div>
                </div>
          ...
          <div className="relative w-full px-6">
            <div className="max-w-6xl mx-auto border-l border-r border-border">
              ...
              <div className="border-t border-border">
                <FAQItem
                  question="What is CarbonScope?"
                  answer="CarbonScope is a generalist AI worker that can perform real-world tasks on your behalf. Unlike traditional AI assistants, CarbonScope can actually take action across your apps, automate workflows, and handle complex multi-step tasks autonomously."
                />
                <FAQItem
                  question="How can CarbonScope help me?"
                  answer="CarbonScope can automate repetitive tasks, manage your workflows, interact with web services, process data, create content, and coordinate complex operations across multiple platforms. Simply tell CarbonScope what you need done, and it handles the execution from start to finish."
                />
                <FAQItem
                  question="How is CarbonScope different from other AI platforms?"
                  answer="While most AI platforms only provide information or suggestions, CarbonScope actually performs real-world tasks. It can browse the web, interact with APIs, manage files, execute commands, and integrate with your existing tools to complete tasks autonomously—not just tell you how to do them."
                />
                <FAQItem
                  question="Can CarbonScope connect to my apps?"
                  answer="Yes! CarbonScope can connect to thousands of apps and services through integrations. It can interact with your tools, APIs, databases, and workflows to automate tasks across your entire tech stack. You control which apps and services CarbonScope can access."
                />
                <FAQItem
                  question="How do I request a new feature?"
                  answer={
                    <>
                      We love feature requests! Email us at <a href="mailto:support@CarbonScope.com" className="text-primary hover:underline font-medium">support@CarbonScope.com</a> with details about what you'd like to see and how it would help you. We carefully review all suggestions and prioritize features based on user feedback for our product roadmap.
                    </>
                  }
                />
                <FAQItem
                ...
                <FAQItem
                  ...
                  answer={
                    <>
                      If your credits don't appear after payment, contact <a href="mailto:support@CarbonScope.com" className="text-primary hover:underline font-medium">support@CarbonScope.com</a> immediately. We prioritize billing and credit issues for all users regardless of tier and will resolve this as quickly as possible, typically within a few hours during business days.
                    </>
                  }
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 border-t border-border">
                <div className="p-8 border-r border-border space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-4">
                      Our terms and conditions for using CarbonScope services, including user responsibilities and service limitations.
                    </p>
                ...
                <div className="p-8 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-4">
                      Company information and legal details about CarbonScope AI Corp, including contact information and registration.
                    </p>
          ...
          <div className="relative w-full px-6 py-16">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <div className="pt-6 space-y-2">
                <p className="text-sm text-muted-foreground">
                  General Inquiries: <a href="mailto:info@CarbonScope.com" className="text-primary hover:underline">info@CarbonScope.com</a>
                </p>
                <p className="text-sm text-muted-foreground">
                  Security Issues: <a href="mailto:security@CarbonScope.com" className="text-primary hover:underline">security@CarbonScope.com</a>
                </p>
              </div>
            </div>
          </div>
